...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, REMOVE_ARTWORK).permitAll()
                .antMatchers(HttpMethod.POST, REMOVE_COLLECTION).permitAll()
                ...
                .antMatchers(HttpMethod.POST, CLOSE_EXHIBITION).permitAll()
                .antMatchers(HttpMethod.POST, CLOSE_CONTEST).permitAll()
