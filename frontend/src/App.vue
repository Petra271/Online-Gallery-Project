<template>
  ...
  <div class="gal_title text-center">Dobrodošli u online galeriju</div>
    ...
    <div v-if="register_form" class="form">
      <v-form
        ref="form"
        v-model="valid"
        lazy-validation
      >
        ...
        >
          Ukoliko se želite prijaviti kao umjetnik trebate priložiti svoj portfolio u obliku PDF datoteke.
        </v-alert>
